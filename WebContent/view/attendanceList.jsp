	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
 		      ...
 		      {field:'date',title:'签到时间',width:200, sortable: false},    
	 		]], 
	        toolbar: "#toolbar",
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								...
								success: function(msg){
									if(msg == "success"){
										$.messager.alert("消息提醒","考勤信息添加成功!","info");
										//关闭窗口
	  ...
	  //添加考勤类型选择框
	   var typeData = [{id:"签到",text:"签到"},{id:"迟到",text:"迟到"},{id:"请假",text:"请假"},{id:"旷课",text:"旷课"}];
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_typeList" style="width: 200px; height: 30px;" class="easyui-textbox" name="type"  />
	    			</td>
	    			<td style="width:80px"></td>
	    		</tr>
	    	</table>
